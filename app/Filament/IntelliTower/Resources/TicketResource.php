...
use App\Filament\IntelliTower\Resources\TicketResource\Pages;
use App\Filament\IntelliTower\Resources\TicketResource\RelationManagers;
use App\Filament\IntelliTower\Resources\TicketResource\RelationManagers\TicketAdjuntosRelationManager;
...
class TicketResource extends Resource
{
    ...
    // Filtrar automáticamente por user_id del usuario autenticado
                ...
                Forms\Components\Section::make('Estado y Prioridad')
                    ...
                    ->schema([
                        Forms\Components\Select::make('estado')
                            ...
                            ->disabled(), // El estado se asigna automáticamente según el tipo
                        ...
                        Forms\Components\Select::make('tecnico.name')
                            ...
                            ->disabled(), // Los usuarios no pueden asignar técnicos
                    ])->columns(3),
            ]);
    }
